...
var Slider = /** @class */ (function (_super) {
    ...
    Slider.prototype.render = function () {
        ...
        var sliderItemsStyle = this.props.vertical
            ...
            : {};
        return (React.createElement("div", { id: this.props.id, "aria-valuemin": this.props.min, "aria-valuemax": this.props.max, "aria-valuenow": this.state.value, "aria-disabled": this.props.disabled ? 'true' : undefined, "aria-labelledby": this.props.ariaLabelledBy, "aria-describedby": this.props.ariaDescribedBy, role: "slider", style: this.props.style, tabIndex: getTabIndex(this.props.tabIndex, this.props.disabled, undefined), onFocus: this.onFocus, onBlur: this.onBlur, onKeyDown: this.onKeyDown, className: classNames('k-slider k-widget k-state-default', this.props.className, {
